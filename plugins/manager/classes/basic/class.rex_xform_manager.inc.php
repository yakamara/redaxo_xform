...
<div class="rex-addon-output">
	<h2 class="rex-hl2">
		Folgendes Feld wird verwendet:
		<?php echo $type_real_field; ?>
	</h2>
...
<?php
    ...
    if ($func == 'choosenadd') {
     ...
     if (!rex_xform_manager_table::hasId($table['table_name'])) {
       ...
       ?>
<div class="rex-addon-output" id="xform-choosenadd">
	<h2 class="rex-hl2">
		<?php echo $I18N->msg('xform_id_is_missing'); ?>
	</h2>
	<div class="rex-addon-content">
		<p class="rex-tx1">
			<?php echo $I18N->msg('xform_id_missing_info'); ?>
		</p>
	</div>
</div>
<?php
...
<div class="rex-addon-output" id="xform-choosenadd">
	<h2 class="rex-hl2">
		<?php echo $I18N->msg('choosenadd'); ?>
	</h2>
	<div class="rex-addon-content">
		<p class="rex-tx1">
			<?php echo $I18N->msg('choosenadd_description'); ?>
		</p>
	</div>
</div>
<?php
...
if ($type_real_field == '' && count($mfields) > 0 ) {
         ?>
<div class="rex-addon-output">
	<h2 class="rex-hl2">Es gibt noch Felder in der Tabelle welche nicht
		zugewiesen sind.</h2>
	<div class="rex-addon-content">
		<?php
		$d = 0;
