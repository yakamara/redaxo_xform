...
$page_size = 200;
$assetsFolder = '/files/addons/xform/plugins/geo/';
...
'.$sql2.'
    ...
    class rex_var_xform_map extends rex_var
    {
		...
		class xform_simulate_sql {
		
		  var $vars = array();
      function 		 xform_simulate_sql ($data) 
      {
          $this->vars = $data;
      } 
      ...
      function getValue($key)
      {
        ...
        $sql = new xform_simulate_sql($d);
    		$rex_var_xform_map = new rex_var_xform_map;
        $d_map_view = $rex_var_xform_map->getFEOutput($sql, $map_view);
        $d_sidebar_view = $rex_var_xform_map->getFEOutput($sql, $sidebar_view);
        $d_print_view = $rex_var_xform_map->getFEOutput($sql, $print_view);
